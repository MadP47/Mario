...
class dragon:
    ...
    def __init__(self):
        self.image = load_image('Pics/dragon.png')
...
class flames:
    ...
    def __init__(self):
        self.image = load_image('Pics/fireball.png')
        self.imagerect = self.image.get_rect()
...
class mario:
    ...
    def __init__(self):
        self.image = load_image('Pics/mario.png')
        self.imagerect = self.image.get_rect()
